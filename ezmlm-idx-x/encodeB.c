/*
 * $Id: encodeB.c,v 1.1 2025-01-22 10:52:37+05:30 Cprogrammer Exp mbhangui $
 */
#include "stralloc.h"
#include "uint32.h"
#include "mime.h"
...
static const unsigned char base64char[64] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
 ...
 */
void
encodeB(const char *indata, unsigned int n, stralloc *outdata, int control)
{
	unsigned char   ch;
	...
	if (!stralloc_copys(outdata, ""))
		die_nomem();
	if (!stralloc_ready(outdata, n * 8 / 3 + n / 72 + 5))
		die_nomem();
