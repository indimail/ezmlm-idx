/*
 * $Id: decodeHDR.c,v 1.1 2025-01-22 10:52:37+05:30 Cprogrammer Exp mbhangui $
 */
#include "stralloc.h"
#include "strerr.h"
#include "error.h"
 ...
 */
void
decodeHDR(const char *indata, unsigned int n, stralloc *outdata)
{
	...
	if (!stralloc_catb(outdata, cpnext, indata - cpnext + n))
		die_nomem();
}
/*
 * $Log: decodeHDR.c,v $
