/*
 * $Id: cookie.c,v 1.1 2025-01-22 10:52:39+05:30 Cprogrammer Exp mbhangui $
 */
#include "cookie.h"
#include "str.h"
#include "uint32.h"
...
void
cookie(char *hash, const char *key, unsigned int keylen, const char *date, const char *addr, const char *action)
{
	surfpcs         s;
	uint32          seed[32];
