/*
 * $Id: decodeQ.c,v 1.1 2025-01-22 10:52:37+05:30 Cprogrammer Exp mbhangui $
 */
#include "stralloc.h"
#include "strerr.h"
#include "messages.h"
 ...
 */
void
decodeQ(const char *cpfrom, unsigned int n, stralloc *outdata)
{
