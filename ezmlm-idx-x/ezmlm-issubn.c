/*
 * $Id: ezmlm-issubn.c,v 1.1 2025-01-22 10:52:37+05:30 Cprogrammer Exp mbhangui $
 */
#include <unistd.h>
#include "strerr.h"
#include "env.h"
...
const char      USAGE[] = "ezmlm-issubn: usage: ezmlm-issubn [-nN] dir [subdir ...]";
