/*
 * $Id: ezmlm-confirm.c,v 1.1 2025-01-22 10:52:37+05:30 Cprogrammer Exp mbhangui $
 */
#include <sys/types.h>
#include <sys/stat.h>
#include <unistd.h>
...
const char      USAGE[] = "ezmlm-confirm: usage: ezmlm-confirm [-cCmMrRvV] dir [/path/ezmlm-send]";
 ...
 */
static int
checkfile(const char *fn, stralloc *fnmsg)
{
	struct stat     st;
	if (!stralloc_copys(fnmsg, "mod/unconfirmed/"))
		die_nomem();
...
main(int argc, char **argv)
{
	...
	if (str_start(action, ACTION_CONFIRM)) {
